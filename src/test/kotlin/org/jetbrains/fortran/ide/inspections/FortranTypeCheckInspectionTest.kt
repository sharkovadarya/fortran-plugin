...
class FortranTypeCheckInspectionTest()
    ...
    fun testDeclarationDoublePrecisionRealToInteger() = checkByText("""
        program p
        integer :: a = <warning descr="mismatched typesexpected `integer`, found `real`">1.0_dp</warning>
        end program
    """, true)
    ...
    fun testDeclarationUnableToInferTypeToInteger() = checkByText("""
        program p
        integer :: a = <warning descr="mismatched argument typesleft argument: integer, right argument: logical"><warning descr="mismatched typesexpected `integer`, found `unknown type`">1 + .true.</warning></warning>
        end program
    """, true)
    ...
    fun testDeclarationUnableToInferTypeToReal() = checkByText("""
        program p
        real :: a = <warning descr="mismatched argument typesleft argument: real, right argument: character"><warning descr="mismatched typesexpected `real`, found `unknown type`">1.1 + "0.1"</warning></warning>
        end program
    """, true)
    ...
    fun testDeclarationDoublePrecisionLogicalToLogical() = checkByText("""
        program p
        logical :: a = <warning descr="mismatched typesexpected `logical`, found `real`">1.0_dp</warning>
        end program
    """, true)
    ...
    fun testDeclarationUnableToInferTypeToLogical() = checkByText("""
        program p
        logical :: a = <warning descr="mismatched argument typesleft argument: logical, right argument: character"><warning descr="mismatched typesexpected `logical`, found `unknown type`">.true. .OR. "false"</warning></warning>
        end program
    """, true)
    ...
    fun testDeclarationDoublePrecisionComplexToComplex() = checkByText("""
        program p
        complex :: a = <warning descr="mismatched typesexpected `complex`, found `real`">1.0_dp</warning>
        end program
    """, true)
    ...
    fun testDeclarationUnableToInferTypeToComplex() = checkByText("""
        program p
        complex :: a = <warning descr="mismatched argument typesleft argument: complex, right argument: character"><warning descr="mismatched typesexpected `complex`, found `unknown type`">(1.0, 2) + "(0.1, 0.2)"</warning></warning>
        end program
    """, true)
    ...
    fun testDeclarationDoublePrecisionCharacterToCharacter() = checkByText("""
        program p
        character :: a = <warning descr="mismatched typesexpected `character`, found `real`">1.0_dp</warning>
        end program
    """, true)
    ...
    fun testDeclarationUnableToInferTypeToCharacter() = checkByText("""
        program p
        character :: a = <warning descr="mismatched argument typesleft argument: character, right argument: complex"><warning descr="mismatched typesexpected `character`, found `unknown type`">"(1.0, 2)" // (0.1, 0.2)</warning></warning>
        end program
    """, true)
    ...
    fun testAssignmentDoublePrecisionComplexToComplex() = checkByText("""
        program p
        complex :: a = <warning descr="mismatched typesexpected `complex`, found `real`">1.0_dp</warning>
        end program
    """, true)
    ...
    fun testDeclarationRealToIntegerArray() = checkByText("""
        program p
        integer, dimension(3) :: a
        a = <warning descr="mismatched typesexpected `integer array of size 3`, found `real array of size 3`">(/1, 2, 3.1/)</warning>
        end program
    """, true)
    ...
    fun testAssignmentWrongArraySize() = checkByText("""
        ...
        a = <warning descr="mismatched typesexpected `logical array of size 3`, found `logical array of size 2`">(/.true., .false./)</warning>
        end program
    """, true)
